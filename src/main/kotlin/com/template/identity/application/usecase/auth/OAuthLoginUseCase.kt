...
class OAuthLoginUseCase(
    ...
    fun execute(command: OAuthLoginCommand): AuthenticationResult {
        ...
        val existingAccount = oauthAccountRepository.findByProviderAndProviderUserId(
            command.provider, userInfo.providerUserId
        )
        ...
        val user = if (existingAccount != null) {
            ...
            if (existingUser != null) {
                val alreadyLinked = oauthAccountRepository
