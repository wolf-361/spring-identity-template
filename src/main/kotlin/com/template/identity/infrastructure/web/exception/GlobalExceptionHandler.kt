...
class GlobalExceptionHandler {
    ...
    fun handleInvalidCredentials(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleEmailAlreadyExists(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleRefreshTokenErrors(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handlePasswordResetErrors(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleUserNotFound(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleOAuthProviderNotSupported(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleOAuthAccountAlreadyLinked(ex: ApplicationException, req: HttpServletRequest) =
    ...
    fun handleLastAuthMethod(ex: DomainException, req: HttpServletRequest) =
